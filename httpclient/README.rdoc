...
* Provides a RJack::HTTPClient::ManagerFacade for client and connection
...
* rjack-commons-codec[http://rjack.rubyforge.org/rjack-commons-codec].

* rjack-slf4j[http://rjack.rubyforge.org/rjack-slf4j].

* An SLF4J output adaptor such as 'rjack-slf4j/simple' or
  rjack-logback[http://rjack.rubyforge.org/rjack-logback] must be
  require'd before rjack-httpclient.  (The logback gem is listed as a
  development dependency only.)

== License

=== rjack-httpclient gem
