=== 9.4.6.0 (2017-6-7)
* Update to Jetty 9.4.6.v20170531
* The minimum thread count is raised to 11 (per jetty error, testing).

=== 9.3.19.0 (2017-6-7)
* Update to Jetty 9.3.19.v20170502

=== 9.3.16.0 (2017-2-13)
* Update to Jetty 9.3.16.v20170120
...
=== 9.3.8.0 (2016-3-23)
* Update to Jetty 9.3.8.v20160314

=== 9.3.7.0 (2016-1-21)
* Update to Jetty 9.3.7.v20160115. Note that this release changes the
  default ciphers for SSL connectors. This results in connection
  failure of a default configured JRuby Net::HTTP client at minimum. A
  workaround was found for local tests.
* Add :inherit_channel option to RJack::Jetty::ServerFactory#connections
  (#9, Akihiro Uchida)
...
=== 9.2.15.0 (2016-3-23)
* Update to Jetty 9.2.15.v20160210
