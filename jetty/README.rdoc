...
* To load webapps with JSPs, the
  rjack-jetty-jsp[http://rjack.rubyforge.org/rjack-jetty-jsp/] gem
  must be loaded.
* Jetty will log to slf4j[http://rjack.rubyforge.org/rjack-slf4j] if
  loaded. The jetty-service script will attempt to load
  rjack-logback[http://rjack.rubyforge.org/rjack-logback], and thus
