...
interest of consumers of the gem, I have decided to break with the
upstream version scheme and release a 1.x major series.

* Upgraded to Logback 0.9.24.
* Logback (as of 0.9.21 actually) now has a hard requirement for SLF4J ~> 1.6.0
