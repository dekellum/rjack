...
* Complete RJack::SLF4J::Logger interface compatibility with Ruby
  ::Logger by added aliases, adaptions, and no-op accessors (fixes #6)
...
* Fix mutation by dup'ing input message in <level>_ex calls,
  (msg,ruby-exception) case (#4, Tom May)
