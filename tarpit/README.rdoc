...
Hoe[http://seattlerb.rubyforge.org/hoe/] (ex: use of Manifest.txt.)
...
good at: java compilation with dependencies, and Rake for everything
else.
...
See the gem dependencies. The rjack-maven gem is only a dependency for
